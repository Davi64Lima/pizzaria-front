      ...
      <div className="max-w-6xl mx-auto flex justify-between items-center px-4 py-3">
        ...
        <nav aria-label="Menu principal">
          <ul className="flex gap-5 text-base items-center">
            <li>
              <Link href="/mount" className="flex items-center gap-1 hover:underline">
                <Menu size={18} /> Montar
              </Link>
            </li>
            <li>
              <Link href="/menu" className="flex items-center gap-1 hover:underline">
                <Pizza size={18} /> Cardápio
              </Link>
            </li>
            <li>
              <Link href="/coupon" className="flex items-center gap-1 hover:underline">
                <Tag size={18} /> Promoções
              </Link>
            </li>
            <li>
              <Link href="/tracker" className="flex items-center gap-1 hover:underline">
